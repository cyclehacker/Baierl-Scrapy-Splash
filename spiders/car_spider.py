...
class CarSpiderSpider(scrapy.Spider):
    ...
    def parse_car(self, response):
        name = response.xpath('//*[@id="carTitle"]/h4/text()').extract_first()
        price = response.xpath('//div[@class="finalPrice"]/span[@class="finalPrice-value"]/text()').extract_first()
        color = response.xpath('//*[@id="carInfo"]/ul/li[5]/span[@class="value"]/text()').extract_first()
        yield {'Name': name,
               'Price': price,
               "Color": color}
